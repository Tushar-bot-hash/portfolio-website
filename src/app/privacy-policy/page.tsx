      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="mb-4 text-sm">
            This Policy also applies to {siteConfig.domain} and any
            other websites, domains, applications, services, products, or
            digital properties owned, operated, or offered by {siteConfig.author}.
          </p>
          ...
          <p className="mb-2 text-sm">We use industry-standard security measures (encryption in transit via HTTPS, access controls, and secure hosting) to protect personal data. We regularly review our security practices but cannot guarantee that unauthorized access, hacking, or data loss will never occur. Report suspected breaches to {siteConfig.links.email} immediately.</p>

          <h4 id="rights" className="mt-4 font-semibold">Your Rights</h4>
          <p className="mb-2 text-sm">You may have rights under applicable data protection laws including to access, correct, update, or delete your personal data. Subject to verification and applicable exceptions, you may also have rights to restrict or object to processing and to request portability of your data. To exercise your rights, send a request to {siteConfig.links.email}.</p>

          <h4 id="international" className="mt-4 font-semibold">International Users & Transfers</h4>
          <p className="mb-2 text-sm">Our Sites are accessible globally and personal data may be transferred to, stored, and processed in various countries. We will take steps to protect your personal data during cross-border transfers.</p>
