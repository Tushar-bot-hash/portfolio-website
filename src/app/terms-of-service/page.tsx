    ...
    <main className="max-w-5xl mx-auto pt-20 sm:pt-24 pb-12 px-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="mb-2 text-sm">As stated in our <a className="underline text-primary" href="/refund-policy">Refund Policy</a>, we generally do not offer refunds. If you believe you are entitled to a refund due to a billing error, duplicate charge, or as required by law, follow the procedure in the Refund Policy. Refund requests can be emailed to <a className="underline text-primary" href={siteConfig.links.email}>{siteConfig.links.email.replace('mailto:', '')}</a>.</p>
