  ...
  <main className="max-w-5xl mx-auto pt-20 sm:pt-24 pb-12 px-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="mb-2 text-sm">This Policy covers paid services, deposits, and fees charged for project work, consulting, and digital goods sold directly via {siteConfig.domain}.</p>
          ...
          <p className="mb-2 text-sm">To request a refund, please do the following:
            <ol className="list-decimal list-inside ml-5 mt-2">
              <li>Identify where you purchased the service ({siteConfig.domain}) and include an invoice/order number or proof of
                payment.</li>
              <li>Email <a className="underline text-primary" href={siteConfig.links.email}>{siteConfig.links.email.replace('mailto:', '')}</a> with your request and supporting documentation.
              </li>
          ...
          <p className="mb-2 text-sm">If a payment dispute arises, parties should contact us at the addresses below to attempt an amicable resolution.</p>
